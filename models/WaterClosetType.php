...
class WaterClosetType extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSource("water_closet_types");
    }
     ...
     * @return WaterClosetType[]|WaterClosetType|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return WaterClosetType|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public $cache_key_prefix = 'newf:dic:water_closet_types:';
    ...
    public function get(int $id): array
    {
        ...
        if ($memcache->exists($cacheKey) && !isset($_GET['_cc'])) {
            ...
            $data = $this->getDI()->get('db')->fetchAll("SELECT * FROM water_closet_types");
            $return = [];
            foreach ($data as $d) {
