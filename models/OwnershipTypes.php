...
class OwnershipTypes extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSource("ownership_types");
    }
     ...
     * @return OwnershipTypes[]|OwnershipTypes|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return OwnershipTypes|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public $cache_key_prefix = 'newf:dic:ownership_types:';
    ...
    public function get(int $id): array
    {
        ...
        if ($memcache->exists($cacheKey) && !isset($_GET['_cc'])) {
            ...
            $data = $this->getDI()->get('db')->fetchAll("SELECT * FROM ownership_types");
            $return = [];
            foreach ($data as $d) {
