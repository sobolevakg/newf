...
class WindowOverlookType extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSource("window_overlook_types");
    }
     ...
     * @return WindowOverlookType[]|WindowOverlookType|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return WindowOverlookType|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public $cache_key_prefix = 'newf:dic:window_overlook_types:';
    ...
    public function get(int $id): array
    {
        ...
        if ($memcache->exists($cacheKey) && !isset($_GET['_cc'])) {
            ...
            $data = $this->getDI()->get('db')->fetchAll("SELECT * FROM window_overlook_types");
            $return = [];
            foreach ($data as $d) {
