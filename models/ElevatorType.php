...
class ElevatorType extends \Phalcon\Mvc\Model
{
     ...
     * @return ElevatorType[]|WaterClosetType|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return ElevatorType|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public $cache_key_prefix = 'newf:dic:elevator_types:';
    ...
    public function get(int $id): array
    {
        ...
        if ($memcache->exists($cacheKey) && !isset($_GET['_cc'])) {
            ...
            $data = $this->getDI()->get('db')->fetchAll("SELECT * FROM elevator_types");
            $return = [];
            foreach ($data as $d) {
