...
class PhoneLineType extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSource("phone_line_types");
    }
     ...
     * @return PhoneLineType[]|PhoneLineType|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return PhoneLineType|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public $cache_key_prefix = 'newf:dic:phone_line_types:';
    ...
    public function get(int $id): array
    {
        ...
        if ($memcache->exists($cacheKey) && !isset($_GET['_cc'])) {
            ...
            $data = $this->getDI()->get('db')->fetchAll("SELECT * FROM phone_line_types");
            $return = [];
            foreach ($data as $d) {
