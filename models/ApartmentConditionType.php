...
class ApartmentConditionType extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSource("apartment_condition_types");
    }
    ...
    {
        return 'apartment_condition_types';
    }
     ...
     * @return ApartmentConditionType[]|ApartmentConditionType|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return ApartmentConditionType|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public $cache_key_prefix = 'newf:dic:apartment_condition_types:';
    ...
    public function get(int $id): array
    {
        ...
        if ($memcache->exists($cacheKey) && !isset($_GET['_cc'])) {
            ...
            $data = $this->getDI()->get('db')->fetchAll("SELECT * FROM apartment_condition_types");
            $return = [];
            foreach ($data as $d) {
