...
class HousingComplexClass extends \Phalcon\Mvc\Model
{
    ...
    public $cache_key_prefix = 'newf:dic:housing_complex_class:';
    ...
    public function get(int $id): array
    {
        ...
        if ($memcache->exists($cacheKey) && !isset($_GET['_cc'])) {
            ...
            $data = $this->getDI()->get('db')->fetchAll("SELECT * FROM housing_complex_class");
            $return = [];
            foreach ($data as $d) {
